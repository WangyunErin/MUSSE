 ...
 public:
   ...
   public:
    ExperimentalWithCallbackMethod_getRofFile() {
      ::grpc::Service::experimental().MarkMethodCallback(1,
        new ::grpc::internal::CallbackUnaryHandler< ::getRofFileRequest, ::getRofFileResponse>(
          [this](::grpc::ServerContext* context,
                 const ::getRofFileRequest* request,
                 ::getRofFileResponse* response,
                 ::grpc::experimental::ServerCallbackRpcController* controller) {
                   return this->getRofFile(context, request, response, controller);
                 }));
    }
    ...
    virtual void getRofFile(::grpc::ServerContext* context, const ::getRofFileRequest* request, ::getRofFileResponse* response, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  template <class BaseClass>
  ...
  class ExperimentalWithRawCallbackMethod_getRofFile : public BaseClass {
   ...
   public:
      ...
      ::grpc::Service::experimental().MarkMethodRawCallback(1,
        new ::grpc::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
          [this](::grpc::ServerContext* context,
                 ...
                 ::grpc::ByteBuffer* response,
                 ::grpc::experimental::ServerCallbackRpcController* controller) {
                   this->getRofFile(context, request, response, controller);
                 }));
    }
    ...
    virtual void getRofFile(::grpc::ServerContext* context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response, ::grpc::experimental::ServerCallbackRpcController* controller) { controller->Finish(::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "")); }
  };
  template <class BaseClass>
