...
class MKSE final {
 public:
  ...
  typedef WithAsyncMethod_setup<WithAsyncMethod_createOMAP<WithAsyncMethod_readStore<WithAsyncMethod_writeInStore<WithAsyncMethod_update<WithAsyncMethod_batchUpdate<WithAsyncMethod_search<WithAsyncMethod_addToFileCntQueue<WithAsyncMethod_batchAddToFileCntQueue<WithAsyncMethod_getFileCntDiff<WithAsyncMethod_updateMerkleRoot<WithAsyncMethod_getMerkleRoot<WithAsyncMethod_downloadStash<WithAsyncMethod_uploadStash<WithAsyncMethod_downloadOMAPRoot<WithAsyncMethod_uploadOMAPRoot<WithAsyncMethod_downloadOMAPMerkleRoot<WithAsyncMethod_uploadOMAPMerkleRoot<WithAsyncMethod_executeFabricCommand<Service > > > > > > > > > > > > > > > > > > > AsyncService;
  template <class BaseClass>
